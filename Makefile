...
# OBJECT GROUPS
_TRIE_OBJECTS=Trie.o
TRIE_OBJECTS=$(patsubst %,$(OBJECT)/%, $(_TRIE_OBJECTS))
TEST_TRIE_OBJECTS=$(patsubst %,$(OBJECT)/test_%,$(_TRIE_OBJECTS))
...
_TEST_SOURCES=test_AhoCorasick.cc test_KMP.cc test_Trie.cc
...
test_aho_corasick: ${TEST}/test_AhoCorasick.cc ${TEST_AHO_CORASICK_OBJECTS} ${BRUTEFORCE_OBJECTS}
	g++ -o ${TESTBIN}/test_AhoCorasick ${TEST}/test_AhoCorasick.cc ${TEST_AHO_CORASICK_OBJECTS} ${BRUTEFORCE_OBJECTS} ${TEST_FLAGS}

test_trie: ${TEST}/test_Trie.cc ${TEST_TRIE_OBJECTS} ${BRUTEFORCE_OBJECTS}
	g++ -o ${TESTBIN}/test_Trie ${TEST}/test_Trie.cc ${TEST_TRIE_OBJECTS} ${BRUTEFORCE_OBJECTS} ${TEST_FLAGS}
...
tests_allinone: ${TEST_SOURCES} ${TEST_AHO_CORASICK_OBJECTS} ${TEST_KMP_OBJECTS} ${TEST_TRIE_OBJECTS} ${BRUTEFORCE_OBJECTS}
	g++ -o ${TESTBIN}/main ${TEST}/test_Main.cc ${TEST_SOURCES} ${TEST_AHO_CORASICK_OBJECTS}  ${TEST_KMP_OBJECTS} ${TEST_TRIE_OBJECTS} ${BRUTEFORCE_OBJECTS}  ${TEST_FLAGS} -lgtest_main

main: ${MAIN_OBJECTS} ${AHO_CORASICK_OBJECTS} ${BRUTEFORCE_OBJECTS} ${KMP_OBJECTS} ${TRIE_OBJECTS}
	g++ -o ${BIN}/main ${SRC}/main.cc ${AHO_CORASICK_OBJECTS} ${BRUTEFORCE_OBJECTS} ${KMP_OBJECTS} ${TRIE_OBJECTS} ${RELEASE_FLAGS}
